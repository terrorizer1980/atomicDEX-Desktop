...
namespace mm2::api
{
    ...
    struct enable_request
    {
        ...
        const std::string        arbitrum_erc_testnet_swap_contract_address{"0x4Bc6c6bfB39Dc3fBcC2410D53665A34f66028cdf"};
        const std::string        arbitrum_erc_testnet_fallback_swap_contract_address{"0x4Bc6c6bfB39Dc3fBcC2410D53665A34f66028cdf"};
